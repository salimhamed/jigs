...
export const maintenance = {
  job: join([
    ...
    'ci "none" means no check has reported on the head: CI may not have started yet, or the repository has none. Do not wait for it; checks that start later reach you as a new update.',
