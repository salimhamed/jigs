...
// Scaffolding: the demos this package still runs on its own, deleted once a
// factory repo supplies its own pipelines. Kept until then as the worked
// example of how a factory declares them.
