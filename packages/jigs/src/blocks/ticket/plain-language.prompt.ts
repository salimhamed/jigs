// The house rules for every line jigs posts on a ticket. Shared by the prompts
// that write those lines, because the reader is the same person each time.

export const plainLanguage = `- Write for someone who has never seen this repository and has no code open in
