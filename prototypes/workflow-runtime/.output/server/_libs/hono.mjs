...
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/compose.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/request/constants.js
var GET_MATCH_RESULT = /* @__PURE__ */ Symbol();
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/utils/buffer.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/utils/body.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/utils/url.js
var splitPath = (path) => {
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/request.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/utils/html.js
...
var Context = class {
	...
	*/
	text = (text, arg, headers) => {
		return !this.#preparedHeaders && !this.#status && !arg && !headers && !this.finalized ? new Response(text) : this.#newResponse(text, arg, setDefaultContentType("text/plain; charset=UTF-8", headers));
	};
	/**
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router.js
var METHODS = [
	"get",
	"post",
	"put",
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/hono-base.js
	...
	route(path, app) {
		...
		app.routes.map((r) => {
			...
			if (app.errorHandler === errorHandler) handler = r.handler;
				...
				handler["__COMPOSED_HANDLER"] = r.handler;
			}
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/utils.js
var createNullObject = () => /* @__PURE__ */ Object.create(null);
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/reg-exp-router/matcher.js
var emptyParam = [];
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/reg-exp-router/trie.js
var Trie = class {
	#context = { varIndex: 0 };
	#root = new Node$1();
	#index = 0;
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/reg-exp-router/router.js
var wildcardRegExpCache = createNullObject();
function buildWildcardRegExp(path) {
	return wildcardRegExpCache[path] ??= new RegExp(`^${path.replace(/\/:[^/{}]+(?:\{\[\^\/]\+})?(?=[/{]|$)|\/?\*$|([.\\+*[^\]$()?{}|])/g, (match2, metaChar) => metaChar ? `\\${metaChar}` : match2 === "/*" ? "(?:|/.*)" : match2 === "*" ? ".*" : `/:[^/]+`)}$`);
}
...
var RegExpRouter = class {
	...
	add(method, path, handler) {
		...
		if (!middleware) throw new Error("Can not add a route since the matcher is already built.");
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/smart-router/router.js
var SmartRouter = class {
	...
	add(method, path, handler) {
		if (!this.#routes) throw new Error("Can not add a route since the matcher is already built.");
		this.#routes.push([
			method,
			path,
			handler
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/trie-router/node.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/router/trie-router/router.js
...
//#endregion
//#region node_modules/.pnpm/hono@4.13.4/node_modules/hono/dist/hono.js
